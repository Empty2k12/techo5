...
func TestRoundScenesDraw(t *testing.T) {
	...
	scenes := map[string]roundScene{
		...
		"contacts":            {now: at, phase: "idle", menuOpen: true, menuMode: modeContacts, phoneReady: true, contacts: []phone.Contact{{Name: "Alex", Number: "15551234567"}, {Name: "Sam", Number: "15557654321"}, {Name: "Kitchen", Number: "106"}, {Name: "Garage", Number: "103"}}},
		"cameras-many":        {now: at, phase: "idle", showCamera: true, camera: home.CameraView{Entity: "camera.c3", Name: "Deck"}, menuOpen: true, menuMode: modeCameras, cameras: []config.Camera{{Entity: "local", Name: "This Spot"}, {Entity: "camera.c1", Name: "Front door"}, {Entity: "camera.c2", Name: "Garage side"}, {Entity: "camera.c3", Name: "Deck"}, {Entity: "camera.c4", Name: "Dining room"}, {Entity: "camera.c5", Name: "Garage inside"}, {Entity: "camera.c6", Name: "Shed front"}, {Entity: "camera.c7", Name: "Shed back"}, {Entity: "camera.c8", Name: "Garage front"}}},
		"jog-brightness-auto": {now: at, phase: "idle", menuOpen: true, menuMode: modeBrightness, brightness: 72, autoOn: true},
